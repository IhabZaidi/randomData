...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  void didChangeDependencies() {
    currentpeer = Provider.of<CurrentChatPeer>(this.context, listen: false);
  ...
  void dispose() {
    WidgetsBinding.instance
        .addPostFrameCallback((_) => currentpeer.setpeer(newpeerid: ''));
  ...
  loadMessagesAndListen() async {
    print("my array lenght => ${messages.length}");
    _gbKeys.clear();
    await FirebaseFirestore.instance
        .collection(DbPaths.collectionmessages)
        .doc(chatId)
  ...
  void scrollToMessageContaining(String searchTerm) {
    print("before getting index");
    int index = messages.indexWhere((message) => message.mssgDoc[Dbkeys.content]
        .toString()
        .toLowerCase()
        .contains(searchTerm.toLowerCase()));
    List tempList = [];
     //tempList.add(messages[index]);
